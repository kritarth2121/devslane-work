...
function About() {
  return (
    <div>
      ...
      >
        <div class="md:w-5/12">
          <div class="MT-10">At participating stores. Restrictions apply.</div>
          <div class="font-semibold my-5">EARNING STARS</div>
          ...
          <div class="font-semibold my-5">BENEFITS</div>
        ...
        <div class="md:w-5/12">
          <div class="font-semibold my-5">TERMS OF USE</div>
          ...
          <div class="font-semibold my-5">REDEEMING REWARDS</div>
