      ...
      <div className="bg-money flex text-center items-center flex-col w-full">
        ...
        <div className="flex flex-col text-left ml-9">
          <div className="flex flex-col md:flex-row justify-start">
            ...
            <div className="flex flex-row md:w-4/12">
              <div>
                <img
                  className="w-28"
        ...
        <div className="border-b-2 w-11/12 border-gray-200 mb-12"></div>
          ...
          <div className="flex flex-col md:flex-row justify-start">
            ...
            <div className="flex flex-row md:w-4/12">
              ...
              <div className="ml-6 my-6">
                <div className="text-xl font-medium mb-5">Preload</div>
                <div>
        ...
        <div className="border-b-2 w-11/12 border-gray-200 mb-12"></div>
        <div className="flex flex-col text-left ml-9">
          <div className="flex flex-col md:flex-row justify-start mb-20">
            ...
            <div className="flex flex-row md:w-4/12">
              ...
              <div className="ml-6">
                ...
                <div>
                  ...
                  <span className="text-green-700 underline"> credit card</span>
